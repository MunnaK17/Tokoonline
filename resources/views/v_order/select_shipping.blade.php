    ...
    <div class="order-summary clearfix">
        ...
        <table class="shopping-cart-table table">
            ...
            <tbody>
                ...
                $fotoProduk = $item->produk->foto ? route('produk.foto', $item->produk->foto) : asset('frontend/img/product01.jpg');
                @endphp
                <tr>
                    <td class="thumb"><img src="{{ $fotoProduk }}" alt="{{ $item->produk->nama_produk }}"></td>
                    <td class="details">
    ...
    <div class="order-summary clearfix">
        ...
        <form id="shippingForm">
            ...
            <div class="form-group">
                ...
                <textarea class="input" name="alamat" id="alamat">{{ Auth::user()->customer->alamat ?? '' }}</textarea>
            </div>
            <div class="form-group">
                <label for="">Kode Pos</label>
                <input type="text" class="input" name="kode_pos" id="kode_pos" value="{{ Auth::user()->customer->pos ?? '' }}">
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const originCityCode = 25986; // kode area asal Depok untuk RajaOngkir Komerce
