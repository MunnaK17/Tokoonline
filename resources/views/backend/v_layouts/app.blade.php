...
<html dir="ltr" lang="en">
  <head>
    ...
    <link
      ...
      type="image/png"
      sizes="16x16"
      href="/admin-assets/assets/images/icon_univ_bsi.png"
    />
    <!-- Custom CSS -->
    <link
      rel="stylesheet"
      type="text/css"
      href="/admin-assets/assets/extra-libs/multicheck/multicheck.css"
    />
    <link
      href="/admin-assets/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.css"
      rel="stylesheet"
    />
          ...
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="#">
              ...
              <b class="logo-icon ps-2">
                ...
                <!-- Dark Logo icon -->
                <img
                  src="/admin-assets/assets/images/logo.png"
                  alt="homepage"
                  class="light-logo"
                  width="25"
                />
              ...
              <span class="logo-text ms-2">
                <!-- dark Logo text -->
                <img
                  src="/admin-assets/assets/images/logo-text.png"
                  alt="homepage"
                  class="light-logo"
                />
              </span>
...
<form id="logout-form" action="{{ route('backend.logout') }}" method="POST" style="display: none;">
    ...
    <script src="/admin-assets/assets/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effects -->
    ...
    <!-- this page js -->
    <script src="/admin-assets/assets/extra-libs/multicheck/datatable-checkbox-init.js"></script>
    <script src="/admin-assets/assets/extra-libs/multicheck/jquery.multicheck.js"></script>
    <script src="/admin-assets/assets/extra-libs/DataTables/datatables.min.js"></script>
    <script>
      /****************************************
       *       Basic Table                   *
       ****************************************/
